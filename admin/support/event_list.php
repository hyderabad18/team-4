...
<title>Bootstrap Example</title>
  ...
  <div class="panel panel-default">
    ...
    <h4>Location of the event</h4>
    Mehdipatnam,Kukkatpally,Secundrabad
    <h4>Start Date</h4>20-07-2018
    <h4>End Date</h4>21-07-2018</div>
  </div>
  <h2>Spoorthi</h2>
  <div class="panel panel-default">
    <div class="panel-body">
    	<h4>Description</h4>A platform for children with special abilities to exhibit their talents. 
<h4>Location of the event</h4> 
Dilsuknagar,Uppal,Secundrabad 
